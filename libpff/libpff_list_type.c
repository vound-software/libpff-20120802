...
{
	static char *function = "libpff_list_element_initialize";
	...
	*element = memory_allocate_structure(
	...
	if( memory_set(
	     *element,
	     0,
	     sizeof( libpff_list_element_t ) ) == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_MEMORY,
...
int libpff_list_element_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_element_free";
	int result            = 1;
...
int libpff_list_element_get_value(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_element_get_value";
...
int libpff_list_element_set_value(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_element_set_value";
...
int libpff_list_initialize(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_initialize";
...
int libpff_list_free(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_free";
	int result            = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function               = "libpff_list_empty";
	int element_index                   = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function                      = "libpff_list_clone";
	int element_index                          = 0;
...
int libpff_list_get_number_of_elements(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_get_number_of_elements";
...
{
	libpff_list_element_t *list_element = NULL;
	static char *function               = "libpff_list_get_element_by_index";
...
{
	libpff_list_element_t *list_element = NULL;
	static char *function               = "libpff_list_get_value_by_index";
	int result                          = 0;

	result = libpff_list_get_element_by_index(
	          list,
	          element_index,
	          &list_element,
	          error );
	...
	if( libpff_list_element_get_value(
	     list_element,
	     value,
	     error ) != 1 )
	{
...
int libpff_list_prepend_element(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_prepend_element";
...
{
	libpff_list_element_t *list_element = NULL;
	static char *function               = "libpff_list_prepend_value";
	...
	if( libpff_list_prepend_element(
	     list,
	     list_element,
	     error ) != 1 )
	{
...
int libpff_list_append_element(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_append_element";
...
{
	libpff_list_element_t *list_element = NULL;
	static char *function               = "libpff_list_append_value";
 ...
 * The value_compare_function should return LIBPFF_LIST_COMPARE_LESS,
 * LIBPFF_LIST_COMPARE_EQUAL, LIBPFF_LIST_COMPARE_GREATER if successful or -1 on error
 *
 * Duplicate entries are allowed by default and inserted after the last duplicate value.
 * Only allowing unique entries can be enforced by setting the flag LIBPFF_LIST_INSERT_FLAG_UNIQUE_ENTRIES
 *
...
{
	libpff_list_element_t *list_element = NULL;
	static char *function               = "libpff_list_insert_element";
	int element_index                   = 0;
	int result                          = -1;
	...
	if( ( insert_flags & ~( LIBPFF_LIST_INSERT_FLAG_UNIQUE_ENTRIES ) ) != 0 )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
	...
	else
	{
		     ...
		     element_index++ )
		{
			...
			else if( result == LIBPFF_LIST_COMPARE_EQUAL )
			{
				if( ( insert_flags & LIBPFF_LIST_INSERT_FLAG_UNIQUE_ENTRIES ) != 0 )
				{
					return( 0 );
			...
			else if( result == LIBPFF_LIST_COMPARE_LESS )
			{
				break;
			}
			else if( result != LIBPFF_LIST_COMPARE_GREATER )
			{
				libcerror_error_set(
				 error,
				 LIBCERROR_ERROR_DOMAIN_ARGUMENTS,
		...
		if( result == LIBPFF_LIST_COMPARE_LESS )
		{
...
{
	libpff_list_element_t *list_element = NULL;
	static char *function               = "libpff_list_insert_value";
	int result                          = 0;
	...
	result = libpff_list_insert_element(
	          list,
	          list_element,
...
int libpff_list_remove_element(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_list_remove_element";
