...
#define PFF_INDEX_NODE_LEVEL_LEAF		0x00

typedef struct pff_index_node_32bit pff_index_node_32bit_t;

struct pff_index_node_32bit
{
	/* The node entries data
	 * Consists of 496 bytes
	 */
	uint8_t entries_data[ 496 ];
	...
	uint8_t back_pointer[ 4 ];
        ...
        /* A weak CRC32 of the first 500 bytes
 	 * Consists of 4 bytes
	 */
	uint8_t crc[ 4 ];
};
...
typedef struct pff_index_node_64bit pff_index_node_64bit_t;

struct pff_index_node_64bit
{
	/* The node entries data
	 * Consists of 488 bytes
	 */
	uint8_t entries_data[ 488 ];
	...
	uint8_t signature[ 2 ];
        ...
        /* A weak CRC32 of the first 492 bytes
 	 * Consists of 4 bytes
	 */
	uint8_t crc[ 4 ];
