...
int libpff_name_to_id_map_read(
     ...
     libcerror_error_t **error )
{
	libfcache_cache_t *name_to_id_map_class_identifiers_data_cache        = NULL;
	libfcache_cache_t *name_to_id_map_entries_data_cache                  = NULL;
	libfcache_cache_t *name_to_id_map_strings_data_cache                  = NULL;
	libfdata_reference_t *name_to_id_map_class_identifiers_data_reference = NULL;
	libfdata_reference_t *name_to_id_map_entries_data_reference           = NULL;
	libfdata_reference_t *name_to_id_map_strings_data_reference           = NULL;
	...
	uint8_t *name_to_id_map_strings_data                                  = NULL;
	...
	size_t name_to_id_map_strings_data_size                               = 0;
	...
	if( libpff_table_get_entry_value_by_entry_type(
	     item_values->table,
	     0,
	     LIBPFF_ENTRY_TYPE_NAME_TO_ID_MAP_ENTRIES,
	     &value_type,
	     &name_to_id_map_entries_data_reference,
	     &name_to_id_map_entries_data_cache,
	     ...
	     error ) != 1 )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
		 "%s: unable to retrieve name to id map entries data reference.",
		 function );

		goto on_error;
	}
	/* Reading the data at once reduces the amount of reads back and forth
	 * also it prevents having to deal with entry boundary in the middle
	 * of entry values.
	 */
	...
	if( libpff_table_get_entry_value_by_entry_type(
	     ...
	     &value_type,
	     &name_to_id_map_strings_data_reference,
	     &name_to_id_map_strings_data_cache,
	     LIBPFF_ENTRY_VALUE_FLAG_IGNORE_NAME_TO_ID_MAP,
	     error ) != 1 )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
		 "%s: unable to retrieve name to id map strings data reference.",
		 function );
	     ...
	     error ) != 1 )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
		 "%s: unable to retrieve name to id map strings data.",
		 function );
	...
	if( libpff_table_get_entry_value_by_entry_type(
	     ...
	     &value_type,
	     &name_to_id_map_class_identifiers_data_reference,
	     &name_to_id_map_class_identifiers_data_cache,
	     LIBPFF_ENTRY_VALUE_FLAG_IGNORE_NAME_TO_ID_MAP,
	     error ) != 1 )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
		 "%s: unable to retrieve name to id map class identifiers data reference.",
		 function );
	...
	/* Reading the data at once reduces the amount of reads back and forth
	 * also it prevents having to deal with entry boundary in the middle
	 * of class identifier values. The data is stored in a separate cache.
	 */
	if( libfdata_reference_get_data(
	     name_to_id_map_class_identifiers_data_reference,
	     file_io_handle,
     ...
     libcerror_error_t **error )
{
	...
	if( ( name_to_id_map_entry_type & 0x0001 ) != 0 )
	{
		...
		internal_name_to_id_map_entry->value_size = name_to_id_map_string_size;
