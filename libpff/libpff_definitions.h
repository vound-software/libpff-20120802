...
{
	LIBPFF_ITEM_FLAG_NON_MANAGED_FILE_IO_HANDLE			= 0x00,
	LIBPFF_ITEM_FLAG_MANAGED_FILE_IO_HANDLE				= 0x01,
...
/* LibPFF performance patch: limits number of records per table up to 64KB. 
 */
#define LIBPFF_MAXIMUM_RECORD_ENTRIES_PER_TABLE 65536

#define check_and_limit_number_of_records(n) \
	if (n > LIBPFF_MAXIMUM_RECORD_ENTRIES_PER_TABLE) \
		n=LIBPFF_MAXIMUM_RECORD_ENTRIES_PER_TABLE
