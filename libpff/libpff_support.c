...
const char *libpff_get_version(
             void )
{
	return( (const char *) LIBPFF_VERSION_STRING );
}
...
int libpff_get_access_flags_read(
     void )
{
	return( (uint8_t) LIBPFF_ACCESS_FLAG_READ );
}
...
{
	static char *function = "libpff_get_codepage";
...
int libpff_set_codepage(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_set_codepage";
     ...
     libcerror_error_t **error )
{
	...
	static char *function            = "libpff_check_file_signature";
...
{
	libbfio_handle_t *file_io_handle = NULL;
	static char *function            = "libpff_check_file_signature_wide";
	size_t filename_length           = 0;
	int result                       = 0;
     ...
     libcerror_error_t **error )
{
	...
	static char *function      = "libpff_check_file_signature_file_io_handle";
