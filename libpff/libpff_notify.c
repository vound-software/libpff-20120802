...
{
	static char *function = "libpff_notify_set_stream";
...
int libpff_notify_stream_open(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_notify_stream_open";
...
int libpff_notify_stream_close(
     libcerror_error_t **error )
{
	static char *function = "libpff_notify_stream_close";
