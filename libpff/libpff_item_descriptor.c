...
int libpff_item_descriptor_clone(
     intptr_t **destination_item_descriptor,
     intptr_t *source_item_descriptor,
     libcerror_error_t **error )
{
	...
	{
		*destination_item_descriptor = memory_allocate_structure_as_value(
		                                libpff_item_descriptor_t );
 ...
 * Returns LIBPFF_TREE_NODE_COMPARE_LESS, LIBPFF_TREE_NODE_COMPARE_EQUAL, LIBPFF_TREE_NODE_COMPARE_GREATER if successful or -1 on error
 */
int libpff_item_descriptor_compare(
     intptr_t *first_item_descriptor,
     intptr_t *second_item_descriptor,
     libcerror_error_t **error )
{
	...
	if( ( (libpff_item_descriptor_t *) first_item_descriptor )->descriptor_identifier < ( (libpff_item_descriptor_t *) second_item_descriptor )->descriptor_identifier )
	{
		return( LIBPFF_TREE_NODE_COMPARE_LESS );
	}
	else if( ( (libpff_item_descriptor_t *) first_item_descriptor )->descriptor_identifier > ( (libpff_item_descriptor_t *) second_item_descriptor )->descriptor_identifier )
	{
		return( LIBPFF_TREE_NODE_COMPARE_GREATER );
	}
	return( LIBPFF_TREE_NODE_COMPARE_EQUAL );
}
