...
int libpff_value_type_copy_to_boolean(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_value_type_copy_to_boolean";
...
int libpff_value_type_copy_to_16bit(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_value_type_copy_to_16bit";
...
int libpff_value_type_copy_to_size(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_value_type_copy_to_size";
     ...
     libcerror_error_t **error )
{
	...
	static char *function = "libpff_value_type_copy_to_floating_point";
...
int libpff_value_type_compare_with_utf8_string(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_value_type_compare_with_utf8_string";
	int result            = 0;
...
int libpff_value_type_compare_with_utf16_string(
     ...
     libcerror_error_t **error )
{
	static char *function = "libpff_value_type_compare_with_utf16_string";
	int result            = 0;
