     ...
     libcerror_error_t **error )
{
	...
	if( internal_file->orphan_item_list != NULL )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_VALUE_ALREADY_SET,
		 "%s: invalid internal file - orphan item list already set.",
		 function );
	...
	if( internal_file->name_to_id_map_list != NULL )
	{
		libcerror_error_set(
		 ...
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_VALUE_ALREADY_SET,
		 "%s: invalid internal file - name to id map list already set.",
		 function );
	...
	result = libpff_io_handle_create_item_tree(
	          internal_file->io_handle,
	          internal_file->file_io_handle,
	          &( internal_file->item_tree_root_node ),
	          internal_file->orphan_item_list,
...
/* TODO set recovery_flags |= LIBPFF_RECOVERY_FLAG_IGNORE_ALLOCATION_DATA ? */
	...
	result = libpff_io_handle_recover_items(
	          internal_file->io_handle,
	          internal_file->file_io_handle,
	          internal_file->unallocated_data_block_list,
	          internal_file->unallocated_page_block_list,
...
{
	libpff_internal_file_t *internal_file        = NULL;
	libpff_offset_list_t *unallocated_block_list = NULL;
     ...
     libcerror_error_t **error )
{
	...
	if( libpff_offset_list_get_offset(
	     unallocated_block_list,
     ...
     libcerror_error_t **error )
{
	...
	if( libpff_item_initialize(
	     ...
	     internal_file,
	     internal_file->item_tree_root_node,
	     (libpff_item_descriptor_t *) internal_file->item_tree_root_node->value,
...
{
	libpff_internal_file_t *internal_file            = NULL;
	libpff_tree_node_t *message_store_item_tree_node = NULL;
	...
	if( message_store_item_tree_node == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_VALUE_MISSING,
		 "%s: invalid message store item tree node.",
		 function );
	...
	if( libpff_item_initialize(
	     ...
	     internal_file,
	     message_store_item_tree_node,
	     (libpff_item_descriptor_t *) message_store_item_tree_node->value,
	     LIBPFF_ITEM_FLAGS_DEFAULT,
	     error ) != 1 )
	{
		libcerror_error_set(
...
{
	libpff_internal_file_t *internal_file             = NULL;
	libpff_tree_node_t *name_to_id_map_item_tree_node = NULL;
	...
	if( name_to_id_map_item_tree_node == NULL )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
		 LIBCERROR_RUNTIME_ERROR_VALUE_MISSING,
		 "%s: invalid name to ip map item tree node.",
		 function );
	...
	if( libpff_item_initialize(
	     ...
	     internal_file,
	     name_to_id_map_item_tree_node,
	     (libpff_item_descriptor_t *) name_to_id_map_item_tree_node->value,
	     LIBPFF_ITEM_FLAGS_DEFAULT,
	     error ) != 1 )
	{
		libcerror_error_set(
     ...
     libcerror_error_t **error )
{
	...
	if( libpff_item_initialize(
	     ...
	     internal_file,
	     internal_file->root_folder_item_tree_node,
	     (libpff_item_descriptor_t *) internal_file->root_folder_item_tree_node->value,
	     LIBPFF_ITEM_FLAGS_DEFAULT,
	     error ) != 1 )
	{
		libcerror_error_set(
     ...
     libcerror_error_t **error )
{
	...
	if( libpff_item_initialize(
	     ...
	     internal_file,
	     item_tree_node,
	     (libpff_item_descriptor_t *) item_tree_node->value,
	     LIBPFF_ITEM_FLAGS_DEFAULT,
	     error ) != 1 )
	{
		libcerror_error_set(
     ...
     libcerror_error_t **error )
{
	...
	if( libpff_list_get_number_of_elements(
	     internal_file->orphan_item_list,
...
{
	libpff_internal_file_t *internal_file     = NULL;
	libpff_tree_node_t *orphan_item_tree_node = NULL;
	...
	if( libpff_list_get_value_by_index(
	     internal_file->orphan_item_list,
	     orphan_item_index,
	...
	if( libpff_item_initialize(
	     ...
	     (libpff_item_descriptor_t *) orphan_item_tree_node->value,
	     LIBPFF_ITEM_FLAGS_DEFAULT,
	     error ) != 1 )
	{
		libcerror_error_set(
...
{
	libpff_internal_file_t *internal_file        = NULL;
	libpff_tree_node_t *recovered_item_tree_node = NULL;
	...
	if( libpff_item_initialize(
	     ...
	     (libpff_item_descriptor_t *) recovered_item_tree_node->value,
	     LIBPFF_ITEM_FLAGS_DEFAULT,
	     error ) != 1 )
	{
		libcerror_error_set(
