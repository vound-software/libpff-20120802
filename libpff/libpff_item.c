     ...
     libcerror_error_t **error )
{
	...
	if( ( flags & ~( LIBPFF_ITEM_FLAG_MANAGED_FILE_IO_HANDLE | LIBPFF_ITEM_FLAG_MANAGED_ITEM_TREE_NODE ) ) != 0 )
	{
		libcerror_error_set(
		 error,
		 LIBCERROR_ERROR_DOMAIN_RUNTIME,
	...
	if( ( flags & LIBPFF_ITEM_FLAG_MANAGED_FILE_IO_HANDLE ) == 0 )
	{
     ...
     libcerror_error_t **error )
{
	...
	if( *item != NULL )
	{
		...
		*item         = NULL;
		...
		/* The internal_file reference is freed elsewhere
		 */
		/* If not managed the file_io_handle and the item_tree_node reference are freed elsewhere
		 */
		if( ( internal_item->flags & LIBPFF_ITEM_FLAG_MANAGED_FILE_IO_HANDLE ) != 0 )
		{
			if( internal_item->file_io_handle != NULL )
			{
		...
		if( internal_item->embedded_object_data_reference != NULL )
		{
			     ...
			     error ) != 1 )
			{
				libcerror_error_set(
				 ...
				 LIBCERROR_ERROR_DOMAIN_RUNTIME,
				 LIBCERROR_RUNTIME_ERROR_FINALIZE_FAILED,
				 "%s: unable to free embedded object data reference.",
				 function );

				result = -1;
			}
		}
		if( internal_item->embedded_object_data_cache != NULL )
		{
			     ...
			     error ) != 1 )
			{
				libcerror_error_set(
				 ...
				 LIBCERROR_ERROR_DOMAIN_RUNTIME,
				 LIBCERROR_RUNTIME_ERROR_FINALIZE_FAILED,
				 "%s: unable to free embedded object data cache.",
				 function );
	...
	else
	{
		     ...
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_GET_FAILED,
			 "%s: unable to retrieve value data reference data.",
			 function );
     ...
     libcerror_error_t **error )
{
	...
	if( libpff_table_get_number_of_sets(
	     internal_item->item_values->table,
	     &table_number_of_sets,
	     error ) != 1 )
	{
		libcerror_error_set(
		 error,
	...
	*number_of_sets = (uint32_t) table_number_of_sets;
     ...
     libcerror_error_t **error )
{
	...
	result = libpff_table_get_entry_value_by_utf8_entry_name(
	          internal_item->item_values->table,
	          set_index,
	          utf8_entry_name,
     ...
     libcerror_error_t **error )
{
	...
	result = libpff_table_get_entry_value_by_utf16_entry_name(
	          internal_item->item_values->table,
	          set_index,
	          utf16_entry_name,
     ...
     libcerror_error_t **error )
{
	...
	size_t value_data_size                     = 0;
	uint32_t value_type                        = LIBPFF_VALUE_TYPE_BOOLEAN;
	int result                                 = 0;
	...
	else if( result != 0 )
	{
		...
		if( libpff_value_type_copy_to_boolean(
		     value_data,
		     value_data_size,
		     entry_value,
		     error ) != 1 )
     ...
     libcerror_error_t **error )
{
	...
	size_t value_data_size                     = 0;
	uint32_t value_type                        = LIBPFF_VALUE_TYPE_INTEGER_16BIT_SIGNED;
	int result                                 = 0;
	...
	else if( result != 0 )
	{
		...
		if( libpff_value_type_copy_to_16bit(
		     value_data,
		     value_data_size,
		     entry_value,
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_CONVERSION,
			 LIBCERROR_CONVERSION_ERROR_GENERIC,
			 "%s: unable to set 16-bit entry value.",
			 function );
	...
	else if( result != 0 )
	{
		 ...
		 && ( value_type != LIBPFF_VALUE_TYPE_INTEGER_64BIT_SIGNED ) )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_UNSUPPORTED_VALUE,
			 "%s: unsupported size value type: 0x%04" PRIx32 ".",
			 function,
			 value_type );
		...
		if( libpff_value_type_copy_to_size(
		     value_data,
		     value_data_size,
		     entry_value,
		     error ) != 1 )
	...
	else if( result != 0 )
	{
		 ...
		 && ( value_type != LIBPFF_VALUE_TYPE_DOUBLE_64BIT ) )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_UNSUPPORTED_VALUE,
			 "%s: unsupported floating point value type: 0x%04" PRIx32 ".",
			 function,
			 value_type );
		...
		if( libpff_value_type_copy_to_floating_point(
		     value_data,
		     value_data_size,
		     entry_value,
		     error ) != 1 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_CONVERSION,
			 LIBCERROR_CONVERSION_ERROR_GENERIC,
			 "%s: unable to set floating point entry value.",
			 function );
	...
	else if( result != 0 )
	{
		if( ( value_type & LIBPFF_VALUE_TYPE_MULTI_VALUE_FLAG ) == 0 )
		{
			libcerror_error_set(
			 ...
			 LIBCERROR_ERROR_DOMAIN_RUNTIME,
			 LIBCERROR_RUNTIME_ERROR_UNSUPPORTED_VALUE,
			 "%s: unsupported multi value type: 0x%04" PRIx32 ".",
			 function,
			 value_type );
		...
		if( value_data != NULL )
		{
			...
			if( internal_multi_value->number_of_values > 0 )
			{
				...
				{
					if( ( value_type == LIBPFF_VALUE_TYPE_MULTI_VALUE_STRING_ASCII )
					 || ( value_type == LIBPFF_VALUE_TYPE_MULTI_VALUE_STRING_UNICODE )
					 || ( value_type == LIBPFF_VALUE_TYPE_MULTI_VALUE_BINARY_DATA ) )
					{
						value_data += 4;
     ...
     libcerror_error_t **error )
{
	...
	if( libpff_tree_node_get_number_of_sub_nodes(
	     internal_item->item_tree_node,
	     number_of_sub_items,
	     error ) != 1 )
	{
...
{
	libpff_internal_item_t *internal_item  = NULL;
	libpff_tree_node_t *sub_item_tree_node = NULL;
	...
	if( libpff_item_initialize(
	     ...
	     sub_item_tree_node,
	     (libpff_item_descriptor_t *) sub_item_tree_node->value,
     ...
     libcerror_error_t **error )
{
	...
	if( ( flags & LIBPFF_ITEM_FLAG_MANAGED_ITEM_TREE_NODE ) == LIBPFF_ITEM_FLAG_MANAGED_ITEM_TREE_NODE )
	{
