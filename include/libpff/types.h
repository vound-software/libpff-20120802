...
/* The Microsoft Visual Studio C++ compiler or earlier versions of the Borland C++ Builder
...
/* Earlier versions of the Borland C++ Builder do not support the intptr_t type definition
 */
...
/* Later versions of the Borland C/C++ compiler define the types in <stdint.h>
 */
#include <stdint.h>
